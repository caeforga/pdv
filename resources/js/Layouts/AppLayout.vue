                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('vender.index')" :active="route().current('vender.index')">
                                    Vender <i class="fas fa-shopping-cart"></i>
                                </jet-nav-link>
                            </div>

                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                <jet-nav-link :href="route('ventas.index')" :active="route().current('ventas.index')">
                                    Ventas <i class="fas fa-list-ul"></i>
                                </jet-nav-link>
                            </div>
                        </div>

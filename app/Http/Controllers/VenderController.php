...
use App\Models\Productos_Vendido;
...
class VenderController extends Controller
{
    ...
    public function terminarVenta( Request $request) {
        $user = DB::table('clientes')->select('id')->where('nombre', $request->cliente)->get();
        foreach ($user as $us) {
            $venta = new Venta();
            $venta->id_cliente = $us->id;
            $venta->saveOrFail();
            $idVenta = $venta->id;
            echo $idVenta;
            ...
            foreach ($productos as $producto) {
                ...
                $productoVendido->id_venta = $idVenta;
    ...
    public function index() {
        ...
        //$clients = Cliente::all();
        return Inertia::render('Vender/Index', [
            'total' => $total,
            'clients' => Cliente::all()]);
    }
    /* public function terminarOCancelarVenta(Request $request) {
    ...
    public function index()
    {
        ...
        return Inertia::render('Vender/Vender', [
            "total" => $total,
